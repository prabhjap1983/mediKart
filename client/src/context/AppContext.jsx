...
//   let totalAmount = 0;
//   for (const item in cartItems) {
//     let itemInfo = products.find((product) => String(product._id) === String(item));
...
// Axios instance with credentials
  ...
  const fetchUser = async () => {
    try {
      ...
      // Only handle errors silently; don't log 401
  ...
  const value = {
    ...
    searchQuery,
    setSearchQuery,
    categories, // frontend hardcoded categories
    axios,
    fetchProducts,
    setCartItems,
  };
