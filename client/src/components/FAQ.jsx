...
//         <h2 className="text-4xl font-bold text-center text-[#4d59e2] mb-12">
...
//                 className="w-full flex justify-between items-center px-6 py-5 text-lg font-semibold text-left text-black focus:outline-none"
//               >
//                 <span>{faq.question}</span>
//                 {openIndex === index ? (
//                   <ChevronUp className="w-5 h-5 text-[#4d59e2]" />
//                 ) : (
//                   <ChevronDown className="w-5 h-5 text-[#4d59e2]" />
//                 )}
//               </button>
//               <div
//                 className={`px-6 text-gray-600 text-base transition-all duration-300 ease-in-out overflow-hidden ${
...
// Updated lighter pastel-like gradient backgrounds
const gradients = [
