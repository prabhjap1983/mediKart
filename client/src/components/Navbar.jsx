...
// const { user, setUser, navigate, setShowUserLogin, cartItems, cartCount } = useContext(AppContext);
...
//           {/* Dynamic cart count */}
//           {cartCount() > 0 && (
//   <span className="absolute -top-1.5 -right-1.5 bg-red-600 text-white text-[10px] font-bold w-5 h-5 rounded-full flex items-center justify-center shadow-md group-hover:scale-105 group-hover:ring-2 group-hover:ring-red-300 transition">
//     {cartCount()}
//   </span>
// )}
...
>
      ...
      {/* Login Button or Profile Icon */}
        {/* {user ? (
          <div className="relative group">
            <img src={user_profile} alt="profile" className="w-12 h-12 rounded-full object-cover" />
  ...
  className="px-4 py-3 hover:bg-sky-100 text-gray-800 cursor-pointer rounded-t-xl transition flex items-center gap-2">
    <svg className="w-5 h-5 text-sky-600" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 3h18M4 7h16M4 11h16M4 15h16M4 19h16" />
    </svg>
    My Orders
  </li>
  <hr className="border-gray-200 mx-4" />
  <li className="px-4 py-3 hover:bg-red-100 text-gray-800 cursor-pointer rounded-b-xl transition flex items-center gap-2">
